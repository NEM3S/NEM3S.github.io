...
export default function Header({ theme, onToggleTheme, onPageChanged }) {
  return (
    <motion.header
      className="fixed h-20 top-0 w-full flex items-center justify-center z-50 bg-white/70 dark:bg-zinc-950/70 border-b border-zinc-200/60 dark:border-white/10 transition-colors duration-300 backdrop-blur-lg"
